...
> Provides the same functionality as the [onBeforeStartPreviewServer](/plugins/dev/hooks#onbeforestartprodserver) plugin hook.
...
> Provides the same functionality as the [onAfterStartPreviewServer](/plugins/dev/hooks#onafterstartprodserver) plugin hook.
