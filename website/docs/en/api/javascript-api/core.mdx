...
See [Configuration file watching](/guide/configuration/rsbuild#configuration-file-watching) for when restart watchers are installed and how loaded config files are watched.
