...
This section describes some of the type definitions that Rsbuild includes.
...
Rsbuild plugins offer a standardized way to extend build functionality through lifecycle hooks and configuration modifications.
