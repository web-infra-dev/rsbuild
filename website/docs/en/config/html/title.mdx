---
description: 'If the HTML template used in the current project already includes the title tag, the html.title will not take effect.'
---
...
| Version | Changes                                           |
| ------- | ------------------------------------------------- |
| v2.0.8  | Added support for async functions in `html.title` |
