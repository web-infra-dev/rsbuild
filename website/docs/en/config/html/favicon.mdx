...
Sets the favicon icon path for all pages. It can be set to:

- a URL.
- an absolute file path.
- a relative path relative to the project [root](/config/root).

After you configure this option, the favicon will be automatically copied to the dist directory during compilation, and the corresponding `link` tag will be added to the HTML.
...
| Version | Changes                                                     |
| ------- | ----------------------------------------------------------- |
| v2.0.8  | Added support for async functions in `html.favicon`         |
