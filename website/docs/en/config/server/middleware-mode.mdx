---
description: "Whether to create Rsbuild's server in middleware mode, which is useful for integrating with other servers."
---
...
> See [Integrate with custom server](/api/javascript-api/server-api#integrate-with-custom-server) for more details.
