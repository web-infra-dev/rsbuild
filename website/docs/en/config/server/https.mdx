---
description: 'Configure HTTPS options to enable HTTPS server. When enabled, HTTP server will be disabled.'
---
...
:::tip
When HTTPS is enabled, Rsbuild uses an HTTP/2 server by default.
:::
