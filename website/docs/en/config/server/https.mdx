...
For basic configuration needs, you can add @rsbuild/plugin-basic-ssl to your project plugins, which will automatically create and cache a self-signed certificate. However, we recommend creating and using your own certificate.
