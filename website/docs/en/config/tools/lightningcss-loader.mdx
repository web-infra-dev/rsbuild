---
description: 'You can set the options for builtin:lightningcss-loader through tools.lightningcssLoader.'
---
...
:::tip
Setting `tools.lightningcssLoader` to `false` only disables the `lightningcss-loader`. If you need to disable the full functionality of Lightning CSS, refer to [Disabling Lightning CSS](/guide/styling/css-usage#disabling-lightning-css).
:::
