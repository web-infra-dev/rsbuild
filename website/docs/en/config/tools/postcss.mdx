---
description: 'Rsbuild integrates PostCSS by default. You can configure postcss-loader through tools.postcss.'
---

# tools.postcss

- **Type:** `Object | Function`
- **Default:** Loads the project's PostCSS config when available, while source maps follow [output.sourceMap](/config/output/source-map).
