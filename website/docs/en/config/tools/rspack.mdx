...
It should be noted that Rspack Loader will be executed in right-to-left order. If you want the Loader you added to be executed before other Loaders (Normal Phase), you should use [appendRules](#appendrules) to add the rule to the end.
