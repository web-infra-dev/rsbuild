...
The usage of `source.exclude` is similar to [source.include](https://rspack.rs/config/module#ruleexclude), supporting passing in strings or regular expressions to match the module path.
