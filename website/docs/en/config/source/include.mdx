...
:::tip
If you are unsure which third-party dependencies in node_modules contain ESNext syntax, you can use the [Check Syntax Plugin](/plugins/list/plugin-check-syntax) of Rsbuild for checking. The plugin can help you find the modules that contain ESNext syntax.
:::
