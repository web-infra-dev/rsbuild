...
:::tip
When using unplugin transform hook, you need to use transformInclude hook to exclude the html module. Transform hook will destroy the html-rspack-plugin plug-in to generate html.
:::
