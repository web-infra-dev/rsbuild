...
The `custom` option can be used to customize shortcuts. Its value is a function that receives the default shortcuts array and returns a new shortcuts array.
