...
Provides Rsbuild's [environment API](/api/javascript-api/environment-api#environment-api), see [Server API - environments](/api/javascript-api/server-api#environments) for more details.
...
Sends some message to HMR client, see [Server API - sockWrite](/api/javascript-api/server-api#sockwrite) for more details.
