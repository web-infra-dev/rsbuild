...
By default, Rsbuild (Rspack) watches all build dependencies and triggers a recompilation when any of these files change. If you want changes in non-build dependency files to cause the page to reload, you can configure this configuration.
