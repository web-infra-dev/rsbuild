...
`reload-page` means that the browser page will automatically reload when a file changes. If you don't explicitly specify a type, the system will default to the reload-page behavior.
