...
Set the URL prefix of static assets in production mode.
...
This config is only used in the production build. In development mode, please use the [dev.assetPrefix](/config/dev/asset-prefix) to set the URL prefix.
