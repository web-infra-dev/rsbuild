---
description: 'In production mode, use this option to configure the URL prefix for static assets, such as a CDN URL.'
---
...
```html
<script defer src="https://cdn.example.com/assets/static/js/index.ebc4ff4fab.js"></script>
```
