---
description: 'Controls whether code minification is enabled, and provides configuration options for the minimizers.'
---
...
For example, use [terser-webpack-plugin](https://github.com/webpack/minimizer-webpack-plugin) to switch to Terser or esbuild.
