...
If you need to enable this option in the production build, please note that the inlined CSS code will not go through Rsbuild's default CSS minimizer. You can manually register the [cssnano](https://github.com/cssnano/cssnano) plugin for PostCSS to compress the inlined code.
