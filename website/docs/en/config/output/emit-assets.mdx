---
description: 'Controls whether to emit static assets such as images, fonts, media, and other file types.'
---
...
Controls whether to emit static assets such as images, fonts, media, and other file types.
