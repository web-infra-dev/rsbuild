---
description: 'When you enable polyfill injection, make sure core-js v3 is installed in your project, which is a popular polyfill library for JavaScript.'
---
...
> See [Polyfill Mode](/guide/advanced/browser-compatibility#polyfills) for more details.

## Install core-js

When you enable polyfill injection, make sure [core-js](https://github.com/zloirock/core-js) v3 is installed in your project, which is a popular polyfill library for JavaScript.
...
| Version | Changes                                           |
| ------- | ------------------------------------------------- |
| v2.0.0  | Rsbuild no longer depends on `core-js` by default |
