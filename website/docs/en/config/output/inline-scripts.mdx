...
Note that, with this option enabled, the script files will no longer be generated in the dist directory, they will only exist inside the HTML file instead.
