...
Source map is an information file that stores the source code mapping relationship. It records each location in the compiled code and the corresponding pre-compilation location. With source map, you can directly view the source code when debugging compiled code.
:::
