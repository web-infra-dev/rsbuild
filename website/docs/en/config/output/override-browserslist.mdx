---
description: 'Specifies the range of target browsers that the project is compatible with.'
---
...
If there is no `browserslist` configs defined in the project, nor `overrideBrowserslist` defined, then Rsbuild uses the [default value](/guide/advanced/browserslist#default-values).
