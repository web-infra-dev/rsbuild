...
1. Upgrade `react` and `react-dom` to version 19. If you can't upgrade, you can install the [react-compiler-runtime](https://npmjs.com/package/react-compiler-runtime) package, which allows the compiled code to run on versions prior to 19.
