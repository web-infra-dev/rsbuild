...
- Recommended: enable the Rust-based React Compiler through [@rsbuild/plugin-react](/plugins/list/plugin-react#reactcompiler). This provides a simpler setup and better build performance.
