---
description: 'Learn how to build a Preact application using Rsbuild.'
---
...
Create a Preact application with [create-rsbuild](/guide/start/quick-start#create-an-rsbuild-application):
