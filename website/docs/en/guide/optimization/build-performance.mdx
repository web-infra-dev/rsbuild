...
If your project uses React Compiler, enable Rsbuild's built-in Rust version of [React Compiler](/guide/framework/react#react-compiler) instead of running React Compiler through Babel to reduce the performance overhead introduced by Babel.
