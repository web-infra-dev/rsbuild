...
See the [Build profiling](/guide/debug/build-profiling) section.
...
Upgrading to the latest version of Rsbuild gives you access to the latest performance optimizations. See [Upgrading Rsbuild](/guide/upgrade/upgrade-rsbuild) for more details.
