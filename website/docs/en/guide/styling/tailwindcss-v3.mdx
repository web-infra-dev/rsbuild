---
description: 'Tailwind CSS v3 guide covering key concepts, configuration, and practical usage in Rsbuild.'
---
...
You can register the `tailwindcss` PostCSS plugin through a [PostCSS configuration file](https://github.com/webpack/postcss-loader#config) or [tools.postcss](/config/tools/postcss).
