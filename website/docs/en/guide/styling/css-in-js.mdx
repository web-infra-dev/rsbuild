---
description: 'This document outlines how to use common CSS-in-JS libraries in Rsbuild.'
---
...
Although the examples are based on React, some CSS-in-JS libraries (such as [vanilla-extract](#use-vanilla-extract)) also support other frameworks.
