---
description: 'Rsbuild supports using Browserslist to specify which browsers should be supported in your web application.'
---
...
1. Install the [core-js](https://github.com/zloirock/core-js) dependency:

import { PackageManagerTabs } from '@theme';

<PackageManagerTabs command="add core-js" />

2. Enable polyfill injection in the config file:
...
{
  "browserslist": ["iOS >= 9", "Android >= 4.4", "last 2 versions", "> 0.2%", "not dead"]
}
```
...
{
  "browserslist": {
    "production": ["chrome >= 107", "edge >= 107", "firefox >= 104", "safari >= 16"],
...
- Set to browsers that support native ES Modules:
