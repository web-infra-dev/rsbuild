...
Rsbuild will set different default values of Browserslist according to [output.targets](/config/output/targets), but we recommend that you explicitly set Browserslist in your project, which will make the compatible scope of the project more clear.
