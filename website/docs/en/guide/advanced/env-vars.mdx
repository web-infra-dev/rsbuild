...
Rsbuild by default injects the some environment variables into the code using [source.define](#using-define). These are replaced with specified values during the build:
