---
description: "Rsbuild doesn't include built-in testing frameworks, but integrates seamlessly with popular testing tools."
---
...
The [rstack-examples](https://github.com/rstackjs/rstack-examples/tree/main/rstest) repository includes a collection of Rstest examples that demonstrate common usage patterns and practices.
