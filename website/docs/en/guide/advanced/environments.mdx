...
Rsbuild Server provides a series of APIs related to the build environment. Users can operate the build products in a specific environment on the server side through the Rsbuild environment API.
...
For example, you can quickly implement an SSR function through the Rsbuild environment API:
...
For detailed usage, please refer to: [SSR Example](https://github.com/rspack-contrib/rspack-examples/tree/main/rsbuild/ssr), [SSR + Express Example](https://github.com/rspack-contrib/rspack-examples/tree/main/rsbuild/ssr-express).
