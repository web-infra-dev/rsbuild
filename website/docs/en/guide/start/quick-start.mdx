...
[create-rsbuild](https://npmjs.com/package/create-rsbuild) provides CLI flags that let you skip the interactive selection steps and create applications with a single command.
