...
| vue      | [Vue](https://vuejs.org/)       | [Using Vue](/guide/framework/vue)                             |
...
By default, Rsbuild CLI auto-detects `src/index.(ts|js|tsx|jsx|mts|cts|mjs|cjs)` as the entry module. You can modify the entry module using the [source.entry](/config/source/entry) option.
