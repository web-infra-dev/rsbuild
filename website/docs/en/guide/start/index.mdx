...
Rsbuild is comparable to build tools like [Vite](https://vitejs.dev/), [Create React App](https://github.com/facebook/create-react-app), and [Vue CLI](https://github.com/vuejs/vue-cli). All include built-in dev servers, command line tools, and sensible build configurations for an out-of-the-box experience.
