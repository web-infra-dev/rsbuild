...
- [llms.txt](https://v2.rsbuild.rs/llms.txt): A structured index file containing the titles, links, and brief descriptions of all documentation pages.

```
https://v2.rsbuild.rs/llms.txt
```

- [llms-full.txt](https://v2.rsbuild.rs/llms-full.txt): A full-content file that concatenates the complete content of every documentation page into a single file.
