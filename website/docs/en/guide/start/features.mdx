...
| -------------------- | ------------------------------------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------- |
| Rspack               | Use Rspack as the bundler by default                                                                                           | <ul><li>[Configure Rspack](/guide/basic/configure-rspack)</li></ul>                                                                 |
| SWC compilation      | Transform and minify JavaScript and TypeScript code with SWC by default                                                        | <ul><li>[Configure SWC](/guide/basic/configure-swc)</li></ul>                                                                       |
...
| Web Workers          | Optional feature, use Web Workers                                                                                              | <ul><li>[Use Web Workers](/guide/basic/web-workers)</li></ul>                                                                       |
...
| Tailwind CSS            | Optional feature, use Tailwind CSS                         | <ul><li>[Use Tailwind CSS](/guide/basic/tailwindcss)</li></ul>                                                    |
| UnoCSS                  | Optional feature, use UnoCSS                               | <ul><li>[Use UnoCSS](/guide/basic/unocss)</li></ul>                                                               |
