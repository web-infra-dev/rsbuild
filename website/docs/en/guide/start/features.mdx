...
| Code minification    | Code minification is enabled by default in production build                                                                    | <ul><li>[output.minify](/config/output/minify)</li></ul>                                                                            |
...
| Features                | Description                                                                | Links                                                                                                                                                          |
| ----------------------- | -------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| PostCSS transformation  | PostCSS transformation is enabled by default, built-in autoprefixer plugin | <ul><li>[CSS Usage](/guide/basic/css-usage)</li><li>[tools.postcss](/config/tools/postcss)</li><li> [tools.autoprefixer](/config/tools/autoprefixer)</li></ul> |
...
| CSS Modules type        | Optional feature, generate type definition for CSS Modules                 | <ul>[Typed CSS Modules Plugin](/plugins/list/plugin-typed-css-modules)</ul>                                                                                    |
