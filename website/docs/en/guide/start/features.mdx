---
description: 'Overview of the main features supported by Rsbuild.'
---
...
| TS compilation       | TypeScript files are compiled using SWC by default                                                        | <ul><li>[TypeScript compilation](/guide/basic/typescript#typescript-transformation)</li></ul>                                       |
...
| Stylus preprocessing    | Optional feature, compile Stylus files                     | <ul><li>[CSS](/guide/styling/css-usage)</li><li>[Stylus plugin](https://github.com/rstackjs/rsbuild-plugin-stylus)</li></ul> |
...
| Features                   | Description                                                                                                                  | Links                                                                                                |
| -------------------------- | ---------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------- |
| Chunk splitting            | A variety of chunk splitting strategies are built into Rsbuild to automatically split the bundle into files of moderate size | <ul><li>[Code splitting](/guide/optimization/code-splitting)</li></ul>                               |
