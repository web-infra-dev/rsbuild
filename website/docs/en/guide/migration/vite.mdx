...
Vite provides some preset type definitions through the `vite-env.d.ts` file. When migrating to Rsbuild, you can use the type definitions provided by `@rsbuild/core`:
