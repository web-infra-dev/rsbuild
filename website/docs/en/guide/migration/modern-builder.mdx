...
- **Browserslist:** The default targets [Baseline](https://web-platform-dx.github.io/web-features/) widely available as of [2025-05-01](https://browsersl.ist/#q=baseline+widely+available+on+2025-05-01), refer to [Default Browserslist](/guide/advanced/browserslist#default-browserslist).
