...
For coding agents that support Skills, install the [migrate-cra-to-rsbuild](https://github.com/rstackjs/agent-skills#migrate-cra-to-rsbuild) skill to help with the migration process.
