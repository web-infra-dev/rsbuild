...
CRA integrates the ESLint plugin and has a set of builtin rules by default.

In the Rsbuild project, you can add the Rsbuild [ESLint plugin](https://github.com/rspack-contrib/rsbuild-plugin-eslint), and add [CRA rule set](https://www.npmjs.com/package/eslint-config-react-app).
