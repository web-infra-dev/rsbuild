...
If the current project has multiple build targets, such as building browser artifacts and Node.js artifacts simultaneously, multiple Rspack configuration files will be generated in the `dist/.rsbuild` directory.
