...
The following shows the basic directory structure for output files. By default, the compiled files will be output in the `dist` directory of the current project.
