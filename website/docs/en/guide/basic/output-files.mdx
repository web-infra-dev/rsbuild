---
description: 'This section covers the output file directory structure and how to control output directories for different file types.'
---
...
To learn about deploying Rsbuild projects, see [Deployment](/guide/basic/deployment).
