...
By default, Rsbuild does not write the output files to disk in development mode. Instead, the files are stored in the memory of the dev server to reduce the overhead of file operations.
