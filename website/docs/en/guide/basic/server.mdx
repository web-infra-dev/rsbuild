...
Rsbuild supports modifying the base path of the server through [server.base](/config/server/base). When we want to access these files through http://localhost:3000/foo/, we can configure the following:
