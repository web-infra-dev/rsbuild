---
description: 'This section explains how to deploy Rsbuild projects to static hosting and runtime platforms.'
---

# Deploy Rsbuild applications

This section explains how to deploy Rsbuild projects to static hosting and runtime platforms.
...
Cloudflare provides several ways to deploy Rsbuild projects. Use Cloudflare Pages when you only need static hosting for the generated output. Use Cloudflare Workers when your application needs to run in the Workers runtime.
...
Cloudflare Workers is a runtime deployment target rather than static hosting. For Rsbuild projects that need to run in the Cloudflare Workers runtime, [rsbuild-cloudflare](https://github.com/Nsttt/rsbuild-cloudflare) is an experimental plugin that reads Wrangler configuration, serves development requests through Miniflare, and emits deployable Worker output.
