...
The above are some common configuration examples. For the complete bundler-chain API, please refer to the [rspack-chain documentation](https://github.com/rspack-contrib/rspack-chain).
