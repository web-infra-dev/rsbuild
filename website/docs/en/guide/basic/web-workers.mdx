...
:::tip Web Workers
Web Workers run in the background, independent of other scripts, without slowing down the page. They let you run long tasks, such as complex calculations or remote requests, without blocking the UI or other scripts. Web Workers make it easier to run work in the background and improve overall performance.
:::
