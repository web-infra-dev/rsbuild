...
Enabling the `isolatedModules` option helps you avoid using syntax that cannot be correctly compiled by SWC and Babel, such as cross-file type references. It will guide you to correct the usage:
