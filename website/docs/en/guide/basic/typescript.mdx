...
The translation maintains the technical accuracy while using natural, professional English commonly found in software documentation. I've also properly formatted the links as markdown references and ensured the code examples remain unchanged.
