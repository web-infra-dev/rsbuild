...
The `isolatedModules` option prevents syntax that SWC and Babel cannot correctly compile, such as cross-file type references. It guides you toward correct usage:
