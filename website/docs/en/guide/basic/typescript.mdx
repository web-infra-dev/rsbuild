...
Rsbuild uses [SWC](/guide/configuration/swc) by default for transforming TypeScript to JavaScript, and also supports switching to [Babel](/plugins/list/plugin-babel) for transformation.
