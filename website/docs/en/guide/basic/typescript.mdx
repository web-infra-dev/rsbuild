...
Rsbuild uses [SWC](/guide/configuration/swc) by default for compiling TypeScript code to JavaScript, and also supports switching to [Babel](/plugins/list/plugin-babel) for compilation.
