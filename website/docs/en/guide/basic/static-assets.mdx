...
You can also combine [URL](https://developer.mozilla.org/en-US/docs/Web/API/URL) with [import.meta.url](https://developer.mozilla) which are native ESM features to import static assets.
