...
Rsbuild has upgraded its dependency on [http-proxy-middleware](https://github.com/chimurai/http-proxy-middleware) from v2 to v3. Some options and behaviors have changed.
...
+     { pathFilter: '/api', target: 'http://localhost:3000/api' },
    ],
  },
};
```
