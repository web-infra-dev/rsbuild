---
description: "This section explains how to upgrade your project's Rsbuild dependencies to the latest version."
---
...
Visit [GitHub - release](https://github.com/web-infra-dev/rsbuild/releases) to view the changes for each version of Rsbuild.
