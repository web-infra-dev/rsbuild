---
description: 'This document lists all breaking changes from Rsbuild 0.7 to 1.0. Use it as a migration reference.'
---
...
The `environments` option provides broader coverage and enables differentiated config across multiple environments. For details, see [Multi-environment builds](/guide/advanced/environments).
:::
