...
1. The environment configuration is not equal to the rsbuild configuration:
   ...
   - When modifying a specific environment configuration, use [modifyEnvironmentConfig](/plugins/dev/hooks#modifyenvironmentconfig) instead of [modifyRsbuildConfig](/plugins/dev/hooks#modifyrsbuildconfig) (to avoid affecting other environments).
