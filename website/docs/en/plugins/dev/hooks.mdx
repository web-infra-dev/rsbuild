...
- [onBeforeStartProdServer](#onbeforestartprodserver): Called before starting the preview server.
- [onAfterStartProdServer](#onafterstartprodserver): Called after starting the preview server.
