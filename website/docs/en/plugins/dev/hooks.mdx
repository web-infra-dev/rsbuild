...
- [onBeforeEnvironmentCompile](#onbeforeenvironmentcompile): Called before running the compile of a single environment.
- [onAfterEnvironmentCompile](#onafterenvironmentcompile): Called after running the compile of a single environment. You can get the build result information.
