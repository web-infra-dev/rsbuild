---
description: 'Use Less as the CSS preprocessor, implemented based on less-loader.'
---
...
```js
const sourceMap = rsbuildConfig.output.sourceMap;
...
:::tip
The `lessLoaderOptions.lessOptions` config is passed to Less. See the [Less documentation](https://lesscss.org/usage/#less-options) for all available options.
:::
