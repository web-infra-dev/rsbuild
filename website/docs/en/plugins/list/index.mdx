...
[@ng-rsbuild/plugin-angular](https://github.com/nrwl/angular-rspack) is a community-maintained Rsbuild plugin that allows you to build Angular applications easily.

### Common

The following are common framework-agnostic plugins:

- [Assets Retry Plugin](https://github.com/rspack-contrib/rsbuild-plugin-assets-retry): Used to automatically resend requests when static assets fail to load.
