---
description: 'You can read about the functionality of Rsbuild plugins and how to develop an Rsbuild plugin in the Plugin System documentation.'
---
...
You can read about the functionality of Rsbuild plugins and how to develop an Rsbuild plugin in the [Plugin development](/plugins/dev/index) documentation.

## Using plugins

Register plugins with the [plugins](/config/plugins) option in Rsbuild config.

With Rsbuild's JavaScript API, register plugins with [addPlugins](/api/javascript-api/instance#rsbuildaddplugins).
...
- [@rsbuild/plugin-tailwindcss](/plugins/list/plugin-tailwindcss): Use Tailwind CSS v4.
...
- [@rsbuild/plugin-css-minimizer](https://github.com/rstackjs/rsbuild-plugin-css-minimizer): Customize the CSS minimizer, switching to [cssnano](https://github.com/cssnano/cssnano) or other tools for CSS compression.
...
- [@lynx-js/react-rsbuild-plugin](https://lynxjs.org/api/rspeedy/react-rsbuild-plugin): Support for [ReactLynx](/guide/framework/react-lynx), building Lynx bundles.
