...
After registering the plugin, when you import an SVG in a JavaScript file, if the imported path contains the `?react` suffix, Rsbuild will call SVGR to transform the SVG into a React component.
