...
<PackageManagerTabs command="add @rsbuild/plugin-babel @rsbuild/plugin-solid@beta -D" />

> For the latest implementation, see [PR #7608](https://github.com/web-infra-dev/rsbuild/pull/7608).
