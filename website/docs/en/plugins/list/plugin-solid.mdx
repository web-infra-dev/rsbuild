...
Options passed to `babel-preset-solid`, please refer to the [babel-preset-solid documentation](https://www.npmjs.com/package/babel-preset-solid) for detailed usage.
