...
Web Workers 是 Rspack 的一等公民，这意味着你不需要任何的 Loader 就可以直接在 Rsbuild 项目中使用 Web Workers。详情可参考 [Rspack - Web Workers](https://rspack.dev/zh/guide/features/web-workers)。
