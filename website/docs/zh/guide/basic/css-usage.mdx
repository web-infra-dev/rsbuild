...
Rsbuild 使用 Rspack 内置的 [lightningcss-loader](https://rspack.dev/guide/features/builtin-lightningcss-loader) 来转换 CSS 代码，它会自动读取项目中的 [browserslist](/guide/advanced/browserslist) 配置，并将 CSS 代码转换为目标浏览器支持的语法。
...
Rsbuild 默认支持 CSS Modules，请阅读 [CSS Modules](/guide/basic/css-modules) 章节来了解 CSS Modules 的完整用法。
