---
description: 'Rsbuild 支持在代码中引用图片、字体、媒体和其他类型文件等静态资源。'
---

# 静态资源

Rsbuild 支持在代码中引用图片、字体、媒体和其他类型文件等静态资源。
...
例如，在 HTML 模板中，`./public/favicon.ico` 文件可以被引用为 `/favicon.ico`，[BASE_URL](/guide/advanced/env-vars#processenvbase_url) 对应服务端的基础路径。
