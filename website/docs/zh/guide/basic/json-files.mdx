...
Rsbuild 提供了 [YAML 插件](https://github.com/rspack-contrib/rsbuild-plugin-yaml)，在注册插件后，你可以在 JavaScript 中引用 `.yaml` 或 `.yml` 文件，它们会被自动转换为 JavaScript 对象。
...
Rsbuild 提供了 [TOML 插件](https://github.com/rspack-contrib/rsbuild-plugin-toml)，在注册插件后，你可以在 JavaScript 中引用 `.toml` 文件，它会被自动转换为 JavaScript 对象。
