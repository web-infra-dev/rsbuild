...
默认的 Web browserslist 已升级到更现代的 [Baseline](https://web-platform-dx.github.io/web-features/)。新的默认值对应于 [`2025-05-01 widely available`](https://browsersl.ist/#q=baseline+widely+available+on+2025-05-01)：
