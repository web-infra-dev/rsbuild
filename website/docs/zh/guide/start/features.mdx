...
| 功能                 | 描述                                          | 相关链接                                                                                                                                                         |
| -------------------- | --------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| PostCSS 转换         | 默认开启 PostCSS 转换，内置 autoprefixer 插件 | <ul><li>[引用样式资源](/guide/basic/css-usage)</li><li>[tools.postcss](/config/tools/postcss)</li><li>[tools.autoprefixer](/config/tools/autoprefixer)</li></ul> |
...
| CSS Modules 类型提示 | 可选功能，生成 CSS Modules 的类型定义文件     | <ul><li>[Typed CSS Modules 插件](/plugins/list/plugin-typed-css-modules)</li></ul>                                                                               |
