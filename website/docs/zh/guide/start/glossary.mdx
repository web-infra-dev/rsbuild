...
指 [Rspack](https://rspack.dev/zh/)、[webpack](https://webpack.js.org/) 等模块打包工具。
...
[Rspack](https://rspack.dev/zh/) 是一个基于 Rust 编写的高性能 JavaScript 打包工具， 它提供对 webpack 生态良好的兼容性，能够无缝替换 webpack， 并提供闪电般的构建速度。
