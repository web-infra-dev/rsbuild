---
description: '本章节介绍如何将 Vite 插件迁移到 Rsbuild 插件。'
---
...
请参考 [插件开发](/plugins/dev/index) 文档来了解更多。
...
:::tip
查看 [配置迁移](/guide/migration/vite#config-migration) 了解如何将 Vite 的配置迁移到 Rsbuild。
:::
...
Rsbuild 插件提供了与 Vite 插件一致的 [apply 属性](/plugins/dev/core#conditional-application)。
