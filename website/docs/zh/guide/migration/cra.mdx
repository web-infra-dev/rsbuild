...
CRA 默认集成了 ESLint 插件并内置了一套规则集。

在 Rsbuild 项目中，你可以添加 Rsbuild [ESLint 插件](https://github.com/rspack-contrib/rsbuild-plugin-eslint)，并添加 [CRA 规则集](https://www.npmjs.com/package/eslint-config-react-app)。
