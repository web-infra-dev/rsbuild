...
- 浏览器范围：默认对齐 [Baseline](https://web-platform-dx.github.io/web-features/) 的 [2025-05-01](https://browsersl.ist/#q=baseline+widely+available+on+2025-05-01) widely available，可参考 [Browserslist 默认值](/guide/advanced/browserslist#browserslist-默认值)。
...
- TypeScript 类型检查：默认不开启，需要手动注册 [@rsbuild/plugin-type-check](https://github.com/rstackjs/rsbuild-plugin-type-check)。
