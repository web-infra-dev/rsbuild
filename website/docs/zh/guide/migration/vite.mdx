...
| [vite-plugin-full-reload](https://www.npmjs.com/package/vite-plugin-full-reload)               | [dev.watchFiles](/config/dev/watch-files)                                                 |
| [vite-plugin-html](https://www.npmjs.com/package/vite-plugin-html)                             | [html.template](/config/html/template)                                                    |
| [vite-plugin-css-injected-by-js](https://www.npmjs.com/package/vite-plugin-css-injected-by-js) | [output.injectStyles](/config/output/inject-styles)                                       |
...
| customLogger                          | [Custom logger](/api/javascript-api/core#自定义-logger)          |
