---
description: 'Rsbuild 支持通过 Browserslist 来设置 Web 应用需要兼容的浏览器范围。'
---
...
1. 安装 [core-js](https://github.com/zloirock/core-js) 依赖：

import { PackageManagerTabs } from '@theme';

<PackageManagerTabs command="add core-js" />

2. 在配置文件中开启 polyfill 注入：
