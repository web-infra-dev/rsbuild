---
description: '在这篇文档中，你可以了解到如何基于 Rsbuild 来构建一个 Vue 3 或 Vue 2 应用。'
---
...
如果你需要使用 Vue 的 JSX 语法，还需要注册 Rsbuild 的 [Vue 3 JSX 插件](https://github.com/rstackjs/rsbuild-plugin-vue-jsx)。
