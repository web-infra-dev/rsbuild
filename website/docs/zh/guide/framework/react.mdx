...
如果需要将 TanStack Start 项目从 Vite 迁移到 Rsbuild，请参考 [TanStack Start 迁移](/guide/migration/tanstack-start)。
...
更多用法参考 [@rsbuild/plugin-react - reactCompiler](/plugins/list/plugin-react#reactcompiler)。
