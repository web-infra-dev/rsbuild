---
description: '在这篇文档中，你可以了解到如何基于 Rsbuild 来构建一个 Svelte 应用。'
---
...
使用 [create-rsbuild](/guide/start/quick-start#create-an-rsbuild-application) 来创建一个基于 Rsbuild 的 Svelte 应用，运行以下命令：
