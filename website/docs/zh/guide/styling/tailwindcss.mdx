...
请注意 Tailwind CSS v4 使用了很多现代 CSS 特性，比如 [Cascade Layers](https://developer.mozilla.org/zh-CN/docs/Learn_web_development/Core/Styling_basics/Cascade_layers)，如果你的目标浏览器不支持这些特性，请优先使用 Tailwind CSS v3，参考 [Tailwind CSS v3](/guide/styling/tailwindcss-v3)。
