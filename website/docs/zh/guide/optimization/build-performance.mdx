...
如果项目中使用了 React Compiler，建议通过 [Rsbuild 内置的 Rust 版本的 React Compiler](/guide/framework/react#react-compiler) 来启用，而不是通过 Babel 接入 React Compiler，从而减少 Babel 带来的性能开销。
