---
description: 'Rsbuild 常见问题解答，聚焦构建与运行时异常排查。'
---
...
> 你可以查看 Rspack 的文档来了解 [module.parser.javascript.exportsPresence](https://rspack.rs/zh/config/module-parser#javascriptexportspresence) 的更多细节。
...
当你启用 polyfill 注入时，请确保项目中已安装 `core-js` v3。
