...
- [onBeforeStartPreviewServer](#onbeforestartprodserver)：在启动预览服务器前调用。
- [onAfterStartPreviewServer](#onafterstartprodserver)：在启动预览服务器后调用。
...
- [modifyRsbuildConfig](#modifyrsbuildconfig)
- [modifyEnvironmentConfig](#modifyenvironmentconfig)
- [onBeforeStartPreviewServer](#onbeforestartprodserver)
- [onAfterStartPreviewServer](#onafterstartprodserver)
- [onExit](#onexit)
