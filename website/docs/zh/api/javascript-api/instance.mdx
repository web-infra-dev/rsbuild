...
> 功能与 [onBeforeStartPreviewServer](/plugins/dev/hooks#onbeforestartprodserver) 插件 hook 一致。
...
> 功能与 [onAfterStartPreviewServer](/plugins/dev/hooks#onafterstartprodserver) 插件 hook 一致。
