---
description: 'Rsbuild JavaScript API 参考，涵盖RsbuildInstance、RsbuildConfig、NormalizedConfig等核心接口和用法。'
---
...
查看 [@rsbuild/core - src/index.ts](https://github.com/web-infra-dev/rsbuild/blob/main/packages/core/src/index.ts) 了解所有导出的类型。
