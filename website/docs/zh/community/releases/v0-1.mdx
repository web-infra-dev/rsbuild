---
description: 'Rsbuild 0.1 发布说明，涵盖新功能、重要变更、生态更新和迁移信息。'
...
> 以上数据基于 Farm 团队搭建的 benchmark，更多信息请参考 [build-tools-performance](https://github.com/rstackjs/build-tools-performance)。
