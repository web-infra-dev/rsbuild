...
- **类型：** [Rspack.RuleSetCondition](https://rspack.dev/zh/config/module#condition)
- **默认值：** `undefined`
- **版本：** `>= 1.0.18`
...
`source.assetsInclude` 的值与 Rspack loader 的 `test` 选项相同，可以是正则表达式、字符串、数组、逻辑条件等，详见 [Rspack RuleSetCondition](https://rspack.dev/zh/config/module#condition)。
