---
description: '用于指定额外需要被 SWC 编译的 JavaScript 文件。'
---
...
:::tip
如果你不确定 node_modules 中的哪些第三方依赖存在 ESNext 的语法，可以使用 [@rsbuild/plugin-check-syntax](https://github.com/rstackjs/rsbuild-plugin-check-syntax) 进行检查，插件可以帮助你找到存在 ESNext 语法的模块。
:::
...
export default {
  source: {
    include: [/node_modules[\\/]query-string[\\/]/, /node_modules[\\/]decode-uri-component[\\/]/],
  },
};
```
...
## 编译 node_modules \{#compile-node_modules}
