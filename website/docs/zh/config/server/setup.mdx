...
通常用于注册中间件，也可以在启动阶段运行其他任务。用法类似于 [onBeforeStartDevServer](/plugins/dev/hooks#onbeforestartdevserver) 和 [onBeforeStartPreviewServer](/plugins/dev/hooks#onbeforestartprodserver) hooks。
