---
description: '通过 tools.lightningcssLoader 可以设置 builtin:lightningcss-loader 的选项。'
---
...
:::tip
将 `tools.lightningcssLoader` 设置为 `false` 仅用于禁用 `lightningcss-loader`。如果你需要禁用 Lightning CSS 完整功能，请参考 [禁用 Lightning CSS](/guide/styling/css-usage#disabling-lightning-css)。
:::
