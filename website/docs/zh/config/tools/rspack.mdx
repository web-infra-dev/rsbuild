...
添加额外的 [Rspack rules](https://rspack.dev/zh/config/module#modulerules) 到 Rspack rules 列表的最前面。
...
添加额外的 [Rspack rules](https://rspack.dev/zh/config/module#modulerules) 到 Rspack rules 列表的最后面。
