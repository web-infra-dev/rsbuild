...
- **类型：** [Rspack.ModuleFederationPluginOptions](https://rspack.dev/zh/plugins/webpack/module-federation-plugin#options)
- **默认值：** `undefined`
...
- 将 Rspack [output.uniqueName](https://rspack.dev/zh/config/output#outputuniquename) 配置的默认值设置为 `moduleFederation.options.name`，使 HMR 可以正常工作。
