---
description: '如果当前项目使用的 HTML 模板中已经包含了 charset 或 viewport meta 标签，那么 HTML 模板中的标签优先级更高。'
---
...
```ts
type MetaFunction = (context: {
  value: MetaOptions;
  entryName: string;
}) => MetaOptions | void | Promise<MetaOptions | void>;
```
