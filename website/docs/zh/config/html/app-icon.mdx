---
description: 'Rsbuild 的 html.app-icon 配置项参考，包含作用、默认值、配置行为和使用示例。'
---
...
`html.appIcon` 用于配置 Web 应用图标。如果你需要向 Web App Manifest 添加更多字段，请在 [public 目录](/guide/basic/static-assets#public-folder)下创建 `manifest.webmanifest` 文件，而不是使用 `html.appIcon` 来生成 manifest。
