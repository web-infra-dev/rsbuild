---
description: 'Rsbuild 的 html.tags 配置项参考，包含作用、默认值、配置行为和使用示例。'
---
...
查看 [插入位置](#injection-position) 了解更多。
...
type HtmlTagHandler = (tags: HtmlTag[], context: HtmlTagContext) => HtmlTag[] | void;
```
