---
description: '用于设置 script 和 style 标签的 crossorigin 属性。'
---
...
```html
<script defer src="https://example.com/static/js/main.js" crossorigin="anonymous"></script>
```

`<style>` 标签变为：

```html
<link href="https://example.com/static/css/main.css" rel="stylesheet" crossorigin="anonymous" />
```
