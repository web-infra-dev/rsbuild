---
description: '为 HTML 所引入的 script 和 link 标签添加完整性属性 —— integrity，使浏览器能够验证引入资源的完整性，以此防止下载的资源被篡改。'
---
...
> 参考：[Cryptographic hash functions](https://www.w3.org/TR/sri/#hash-functions)。
