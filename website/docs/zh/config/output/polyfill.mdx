---
description: '当你启用 polyfill 注入时，请确保项目中已安装 core-js v3，它是一个流行的 JavaScript polyfill 库。'
---
...
> 请查看 [Polyfill 方案](/guide/advanced/browser-compatibility#polyfills) 了解详细内容。

## 安装 core-js

当你启用 polyfill 注入时，请确保项目中已安装 [core-js](https://github.com/zloirock/core-js) v3，它是一个流行的 JavaScript polyfill 库。
