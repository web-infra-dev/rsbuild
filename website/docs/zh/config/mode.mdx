...
Rsbuild `mode` 的值也会传递给 Rspack 的 [mode](https://rspack.dev/zh/config/mode) 配置。
...
- 开启 HMR，注册 [HotModuleReplacementPlugin](https://rspack.dev/zh/plugins/webpack/hot-module-replacement-plugin)。
...
- 开启 JavaScript 代码压缩，注册 [SwcJsMinimizerRspackPlugin](https://rspack.dev/zh/plugins/rspack/swc-js-minimizer-rspack-plugin)。
- 开启 CSS 代码压缩，注册 [LightningCssMinimizerRspackPlugin](https://rspack.dev/zh/plugins/rspack/lightning-css-minimizer-rspack-plugin)。
