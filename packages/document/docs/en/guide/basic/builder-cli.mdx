...
Rsbuild CLI will read the `builder.config.ts` configuration file located in the root directory of your project by default. You can use [all the configuration options](/api/index) provided by Rsbuild in the configuration file.
