...
Several [chunk splitting strategies](/guide/optimisation/split-chunk) are built into Rsbuild. These should meet the needs of most applications. You can also customize the chunk splitting config to suit your own usage scenario.
