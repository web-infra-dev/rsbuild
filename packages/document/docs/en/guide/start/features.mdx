...
| Extract CSS files       | CSS will be extracted as separate files by default                                 | <ul><li>[output.disableCssExtract](/config/output/disable-css-extract)</li></ul>                                                                               |
...
| Inline CSS into JS      | Optional feature, inline CSS files to JavaScript files                             | <ul><li>[CSS Usage](/guide/basic/css-usage)</li><li>[tools.styleLoader](/config/tools/style-loader)</li></ul>                                                  |
