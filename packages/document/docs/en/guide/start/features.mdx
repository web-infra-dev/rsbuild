...
| JS minification      | JS minification is enabled by default in production (will be replaced by [output.minify](/config/output/minify))) build        | <ul><li>[output.disableMinimize](/config/output/disable-minimize)</li></ul>                                                         |
| Code minification    | Enable and configure options of code minification in production build                                                          | <ul><li>[output.minify](/config/output/minify)</li></ul>                                                                            |
