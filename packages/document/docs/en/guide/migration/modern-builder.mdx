...
Most configuration options in Rsbuild and Builder are consistent, with only a few adjustments.

You can refer to the [Rsbuild options](/config/options) to view the configuration options for Rsbuild.
