...
- Configure [asset modules](https://rspack.dev/guide/asset-module) rule to handle this type of asset via [tools.rspack](/config/tools/rspack).
...
| [style.sass](https://craco.js.org/docs/configuration/style/#stylesass)                          | [tools.sass](/config/tools/sass)                                 |
