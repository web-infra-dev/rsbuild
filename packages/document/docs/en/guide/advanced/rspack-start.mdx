...
import { rspackProvider } from '@rsbuild/rspack-provider';
...
- [source.include](/config/options/source.html#sourceinclude) ([track issue](https://github.com/web-infra-dev/rspack/issues/3067))
- [source.exclude](/config/options/source.html#sourceexclude) ([track issue](https://github.com/web-infra-dev/rspack/issues/3067))
...
- [output.polyfill.usage](/config/options/output.html#usage) ([track issue](https://github.com/web-infra-dev/rspack/issues/3067))
...
| Type Checker                              | Rsbuild runs TypeScript type checker by default                                                                                                                                                                                  | <ul><li>[Type checking](/guide/basic/typescript.html#type-checking)</li><li>[output.disableTsChecker](/config/options/output#outputdisabletschecker)</li></ul> |
...
In this case, you can disable type checking using [output.disableTsChecker](/config/options/output.html#outputdisabletschecker) to see if Rspack performance meets your expectations after excluding type checking.
