...
Bump Rspack to v0.5.0, see: [Rspack 0.5 Release Announcement](https://www.rspack.dev/blog/announcing-0.5)

Notable changes:

- [Module Federation added to Rspack](https://www.rspack.dev/blog/module-federation-added-to-rspack.html)
- [Remove deprecated builtins options](https://www.rspack.dev/blog/announcing-0.5#make-swchelpers-and-react-refresh-as-peerdependencies)
