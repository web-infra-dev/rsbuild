...
Configure the behavior of SWC to transform React code, corresponding to SWC's [jsc.transform.react](https://swc.rs/docs/configuration/compilation#jsctransformreact) option.
