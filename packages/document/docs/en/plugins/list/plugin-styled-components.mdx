...
Rsbuild provides compile-time support for styled-components. For details, please refer to [rspack#styledComponents](https://www.rspack.dev/guide/loader.html#optionsrspackexperimentsstyledcomponents).
...
You can check the [styled-components documentation](https://www.rspack.dev/zh/guide/loader.html#optionsrspackexperimentsstyledcomponents) to learn how to use it.
