...
For details, please refer to [Rspack#styledComponents](https://rspack.dev/guide/loader.html#optionsrspackexperimentsstyledcomponents).
...
You can check the [styled-components documentation](https://rspack.dev/guide/loader.html#optionsrspackexperimentsstyledcomponents) to learn how to use it.
