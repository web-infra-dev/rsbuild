...
You can check the [styled-components documentation](https://www.rspack.dev/guide/loader.html#optionsrspackexperimentsstyledcomponents) to learn how to use it.
