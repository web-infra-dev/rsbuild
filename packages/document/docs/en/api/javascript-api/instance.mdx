...
## rsbuild.createDevServer `experimental`
...
If you want to integrate Rsbuild DevServer into an existing Server, you can use this method to obtain the instance methods of Rsbuild DevServer and call them on demand.
...
export async function startDevServer() {
  ...
  return {
    close: async () => {
      // Trigger the close of Rsbuild DevServer when the custom server is close
