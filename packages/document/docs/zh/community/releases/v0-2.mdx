...
![](https://lf3-static.bytednsdoc.com/obj/eden-cn/rjhwzy/ljhwZthlaukjlkulzlp/rsbuild/Rsbuild-release-0-2.png)
...
自 Rsbuild v0.1.0 起，`source.entries` 已更名为 `source.entry`，我们在 Rsbuild v0.2.0`中删除了`source.entries` 配置。
