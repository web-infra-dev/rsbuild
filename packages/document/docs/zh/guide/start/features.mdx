...
| 模块联邦        | 可选功能，动态加载模块，并共享依赖关系                           | <ul><li>[moduleFederation.options](/config/module-federation/options)</li></ul>                                            |

## CSS 编译

| 功能                 | 描述                                          | 相关链接                                                                                                                                                         |
| -------------------- | --------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| PostCSS 编译         | 默认开启 PostCSS 编译，内置 autoprefixer 插件 | <ul><li>[引用样式资源](/guide/basic/css-usage)</li><li>[tools.postcss](/config/tools/postcss)</li><li>[tools.autoprefixer](/config/tools/autoprefixer)</li></ul> |
...
| Lightning CSS        | 可选功能，使用 Lightning CSS 提升编译性能     | <ul><li>[Lightning CSS 插件](/plugins/list/plugin-lightningcss)</li></ul>                                                                                        |
...
| Vue 3 JSX     | 可选功能，开启 Vue 3 JSX 语法编译       | <ul><li>[Vue JSX 插件](/plugins/list/plugin-vue-jsx)</li></ul>                         |
| Vue 2 SFC     | 可选功能，开启 Vue 2 SFC 单文件组件编译 | <ul><li>[Vue 2 插件](/plugins/list/plugin-vue2)</li></ul>                              |
| Vue 2 JSX     | 可选功能，开启 Vue 2 JSX 语法编译       | <ul><li>[Vue 2 JSX 插件](/plugins/list/plugin-vue2-jsx)</li></ul>                      |
