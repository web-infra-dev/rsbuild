...
Rsbuild 提供了一个 Module Federation 的示例项目，请参考 [module-federation-examples - module-federation](https://github.com/module-federation/module-federation-examples/tree/e82f94a/cra)。
