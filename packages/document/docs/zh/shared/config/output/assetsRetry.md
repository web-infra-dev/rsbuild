...
如果想要 `assetsRetry` 对自定义模版中的资源生效，可参考 [自定义插入示例](https://github.com/jantimon/html-webpack-plugin/tree/main/examples/custom-insertion-position) 来修改 [html.inject](https://rsbuild.dev/zh/config/options/html.html#htmlinject) 配置和自定义模版。
