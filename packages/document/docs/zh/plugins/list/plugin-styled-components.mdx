...
详情可参考 [Rspack#styledComponents](https://rspack.dev/zh/guide/loader#optionsrspackexperimentsstyledcomponents)。
...
可查阅 [styled-components 文档](https://rspack.dev/zh/guide/loader#optionsrspackexperimentsstyledcomponents) 来了解具体用法。
