...
:::tip
在使用 Rspack 作为打包工具时，仅支持在 [disableCssExtract](https://rsbuild.dev/zh/api/config-output.html#outputdisablecssextract) 时使用该配置。

修改 CSS Modules 相关配置，推荐使用 [output.cssModules](https://rsbuild.dev/zh/api/config-output.html#outputcssmodules) 配置项。
:::
