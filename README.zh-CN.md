...
- **框架无关**：Rsbuild 不与前端 UI 框架耦合，并通过插件来支持 React、Vue、Svelte、Solid、Lit 等框架，未来也计划支持社区中更多的 UI 框架。

## 🎯 生态

除了作为一个构建工具使用，Rsbuild 也为上层的框架和工具提供通用的构建能力，比如 [Rspress](https://github.com/web-infra-dev/rspress) 和 [Rslib](https://github.com/web-infra-dev/rslib)，使它们能够专注于开发自己领域特定的能力。
